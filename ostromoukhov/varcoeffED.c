...
unsigned long DEFAULT_OUTPUT_DIMS_X = 512;
unsigned long DEFAULT_OUTPUT_DIMS_Y = 512;
...
int main(int argc, char **argv)
{
  ...
  DEFAULT_OUTPUT_DIMS_X = strtoul(argv[1], NULL, 0);
  DEFAULT_OUTPUT_DIMS_Y = strtoul(argv[2], NULL, 0);
